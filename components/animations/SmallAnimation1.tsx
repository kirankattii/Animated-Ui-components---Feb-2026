...
/**
 * Magnetic Component
 * Wraps a child element and adds a magnetic mouse-follow effect.
 * This version uses the Framer Motion library to ensure compatibility 
 * and performance within the environment while remaining fully reusable.
 */
const Magnetic = ({ children }: { children: React.ReactNode }) => {
    ...
    // Spring configuration for the "elastic" feel
    ...
    const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        // Set values (multiplied by a factor to control "pull" strength)
 ...
 * Main App Component
 */
export default function SmallAnimation1() {
    const icons = [
        {
            id: 'facebook',
            viewBox: "0 0 31.5 58",
    ...
    return (
        <main className="flex flex-col items-center justify-center min-h-screen bg-[#0f0f0f] text-[#494136] font-sans p-4">
            ...
            <footer className="absolute bottom-8 text-[9px] md:text-[11px] opacity-30 uppercase tracking-[0.25em] pointer-events-none">
                Reusable Component • Library Implementation
            </footer>
        </main>
    );
}
