    ...
    return (
        <div className="min-h-screen bg-slate-50 p-4 md:p-12 font-sans selection:bg-indigo-100">
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                {/* Section 3: Masonry Editorial Grid UI (Based on Celio Image) */}
                <div className="space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        <LayoutGrid className="w-6 h-6 text-indigo-500" />
                        <h2 className="text-2xl font-bold text-slate-900">Campaign Ready Editorial Grids</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                        {/* Main Tall Feature Card */}
                        <div className="md:col-span-4 rounded-3xl overflow-hidden relative group h-[600px] shadow-sm border border-gray-100">
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent z-10 opacity-60 group-hover:opacity-80 transition-opacity"></div>
                            <div className="absolute inset-0 bg-slate-200 flex items-center justify-center">
                                <div className="text-center p-8 z-20 text-white">
                                    <h3 className="text-4xl font-black mb-2 tracking-tighter">MOVE EASY</h3>
                                    <p className="text-sm font-light opacity-90 max-w-[200px]">Presenting the loose fit jeans from Celio</p>
                                </div>
                                <div className="absolute inset-0 bg-indigo-50 flex items-center justify-center">
                                    {/* Mock Image Placeholder */}
                                    <div className="w-2/3 h-4/5 bg-white shadow-xl rounded-lg"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-8 flex flex-col gap-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[250px]">
                                <div className="bg-slate-100 rounded-3xl overflow-hidden relative">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[334px]">
                                <div className="bg-slate-100 rounded-3xl overflow-hidden relative">
                                    <div className="absolute bottom-4 left-4 z-10 text-slate-700 font-bold bg-white/80 px-4 py-2 rounded-full text-xs">SUMMER DRIVE</div>
                                </div>
                                <div className="bg-slate-100 rounded-3xl overflow-hidden relative">
                        ...
                        {/* Bottom Full-Width Brand Card */}
                        <div className="md:col-span-12 h-[350px] bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden relative flex items-center justify-center">
                            ...
                            <div className="z-20 flex flex-col items-center">
                                <div className="text-5xl font-bold tracking-tight text-slate-900 mb-2">celio<span className="text-rose-500">*</span></div>
                                <div className="text-slate-500 font-medium tracking-widest text-sm uppercase">do it your way.</div>

                                {/* Mock Models Row */}
                                <div className="flex gap-12 mt-12">
                                    <div className="w-16 h-24 bg-slate-100 rounded-lg shadow-inner"></div>
                                    <div className="w-16 h-24 bg-slate-100 rounded-lg shadow-inner"></div>
                                    <div className="w-16 h-24 bg-slate-100 rounded-lg shadow-inner"></div>
                                </div>
                            </div>
